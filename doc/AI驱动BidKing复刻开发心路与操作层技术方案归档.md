...
凡是项目的 AI 协作方式、证据链、clean-room 边界、文档同步机制、验收方法或复刻生产流程发生实质变化，都应补到本文。它不替代两套策划归档，也不承载原版规则口径；它维护的是这套研发方式本身。
...
- 素材链路从早期样例资产转向 approved WebP、源表绑定资源键、懒加载和正式 UI 图素；视觉仍是 clean-room 替代，不把原商业资源带入分发工程。
...
- 原始商业源码和商业资源不分发；视觉使用 approved clean-room 资产，音频只在本地开发中按授权素材只读映射，支付、DLC、平台库存等外部服务明确分类为替代或模拟。
