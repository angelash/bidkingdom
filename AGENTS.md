# BidKingdom Agent Index

本文件只作为仓库内 agent / Cursor / Codex 的入口索引。具体工作规则不要重复写在这里，统一维护在对应规则文件和归档文档中。

## Rules

- BidKingdom 原版复刻文档同步规则：`.cursor/rules/bidkingdom-doc-sync.mdc`
- BidKingdom 单主干 Git 工作流规则：`.cursor/rules/bidkingdom-main-only.mdc`
- BidKingdom 公网运行维护规则：`.cursor/rules/bidkingdom-public-runtime.mdc`
...
- AI 协作研发耗时统计归档：`doc/AI驱动BidKing复刻开发耗时统计归档.md`

## Code Roots

- 原版逆向、源码、配置和资源线索：`reverse`
- 当前前端/应用实现：`apps`
- 当前共享包和业务代码：`packages`
- 项目文档：`doc`
